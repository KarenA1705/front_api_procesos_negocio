//funciones propias de la app para el modulo de usuarios
    ...
    .then(function(usuario){
            ...
            if(usuario){                
                ...
                <form action="" method="post" id="myForm">
                    ...
                    <input type="text" class="form-control" name="direccion" id="direccion"  value="${usuario.direccion}"> <br>

                    <label for="fechaNacimiento"  class="form-label">fecha de nacimiento</label>
                    <input type="text" class="form-control" name="fechaNacimiento" id="fechaNacimiento" value="${usuario.fechaNacimiento}"> <br>

                    <label for="telefono"  class="form-label">Telefono</label>
                    <input type="text" class="form-control" name="telefono" id="telefono"  value="${usuario.telefono}"> <br>
...
function registerForm(){
    cadena = `
            ...
            <form action="" method="post" id="myForm">
                ...
                <label for="fechaNacimiento"  class="form-label">Fecha de nacimiento</label>
                <input type="text" class="form-control" name="fechaNacimiento" id="fechaNacimiento" required> <br>

                <label for="telefono"  class="form-label">Telefono</label>
                <input type="text" class="form-control" name="telefono" id="telefono" required> <br>
